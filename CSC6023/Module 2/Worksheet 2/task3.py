...
class AVLTree(object):
    ...
    '''
    I am implementing my depth-first post order tree
    here so we can print it out in the main function.
    '''
...
def main():
    ...
    # here we will print out the tree so it can be compared to post order
    print("First let's print the tree using built in method:")
    myTree.printHelper(root, "", True)
    print("\nNow printing the post order traversal:")
