...
select R.RecipeName, R.CookbookName, count(IngredientId)
from Recipe as R inner join Meal as I on R.RecipeName = I.RecipeName
group by RecipeName
order by count(IngredientId), R.RecipeName, R.CookbookName;

select R.RecipeName, R.CookbookName
from Recipe as R
