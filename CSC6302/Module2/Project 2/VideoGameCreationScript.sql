...
INSERT INTO Series (SeriesName) VALUES ("Naruto: Clash of Ninja");
INSERT INTO Game (GameName, ReleaseDate, ConsoleName, Series, NumPlayers) VALUES ("Naruto: Clash of Ninja", "2006-03-07", "Game Cube", 8, 2);
INSERT INTO Game (GameName, ReleaseDate, ConsoleName, Series, NumPlayers) VALUES ("Naruto: Clash of Ninja 2", "2006-09-26", "Game Cube", 8, 2);
INSERT INTO Game (GameName, ReleaseDate, ConsoleName, Series, NumPlayers) VALUES ("Naruto: Clash of Ninja Revolution", "2007-10-23", "Wii", 8, 2);

select GameName
from Game
where ConsoleName = 'Game Cube';
...
update Game
set Numplayers = 2
where GameName = 'Spyro the Dragon';

select distinct GameName
from Game as G, Console as C
where C.ReleaseDate < '2000-01-01' and G.ReleaseDate < '2000-01-01';

select GameName, ConsoleName, Series
from Game
where ReleaseDate between '1995-01-01' and '2018-01-01';
...
INSERT INTO Series (SeriesName) VALUES ("NBA2k");
...
INSERT INTO Game (GameName, ReleaseDate, ConsoleName, Series, NumPlayers) VALUES ("NBA2K24", "2023-09-08", "Play Station 5", 9, 4);
